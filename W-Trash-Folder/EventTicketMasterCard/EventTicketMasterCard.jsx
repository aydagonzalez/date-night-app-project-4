import ConcertImg from '../../../W-Trash-Folder/ConcertImg/ConcertImg'
import PriceRange from '../PriceRange/PriceRange'

export default function EventTicketMasterCard({ event }) {
  ...
  return (
    <div>
      ...
      <div>Dates-start: {event.dates.start.localTime} Dates-Timezone: {event.dates.timezone}</div>
